...
/* harmony import */ var _context__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("HbWr");
...
function MyApp({
  ...
  return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])(_context__WEBPACK_IMPORTED_MODULE_2__[/* Provider */ "b"], {
...
class Provider extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  componentDidMount() {
    fetch("https://lhmstrapi.herokuapp.com/products").then(res => res.json()).then(data => this.setState({
      data
